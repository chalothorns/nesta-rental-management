        ...
        <tr className="border-b hover:bg-gray-50 ">
            ...
            <td className="p-3 w-40">
                <input
                    ...
                    readOnly
                    onChange={() => {}}
                    className="w-32 h-10 px-2 py-1 text-base text-left bg-gray-100 border border-gray-200 rounded-lg cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-custom-blue focus:ring-offset-2 focus:border-gray-200"
                />
            </td>
            ...
            <td className="p-3 text-center">
                <input
                    ...
                    placeholder="0"
                    className="w-32 h-10 px-2 py-1 text-base text-left border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none focus:ring-2 focus:ring-custom-blue focus focus:ring-offset-2 focus:border-gray-200"
                />
            </td>
