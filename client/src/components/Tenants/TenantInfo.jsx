...
export const TenantInfo = ({ modalMode, handleOpenEditModal }) => {
  return (
    <div>
              ...
              <div className="flex items-center ">
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    <p className="text-base  text-white">{modalMode === "edit" ? "แก้ไขข้อมูล" : "เพิ่มผู้เช่าใหม่"}</p>
                  </button>
                </div>
              </div>
              <button
            ...
            <div className="md:grid grid-cols-2 mt-6">
              <div className="md:ml-5">
                ...
                <div className="flex mb-2 mt-2">
                  ...
                  <p className="text-lg  text-gray-500">081-234-5678</p>
                </div>
                <div className="flex mb-3">
                  <HiOutlineMail className="w-5 h-5 text-[#53b8e0] mr-2" />
                  <p className="text-lg  text-gray-500">john.smith@email.com</p>
                </div>
                ...
                <div className="block md:hidden">
                  ...
                  <div className="flex justify-between text-lg mb-2">
                    ...
                    <p className="text-black font-semibold">฿17,000</p>
                  </div>

                  <div className="flex justify-between text-lg mb-2">
                    <p className=" text-gray-500 ">ระยะเวลาสัญญา: </p>
